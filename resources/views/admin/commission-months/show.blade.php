                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 text-right font-semibold text-gray-700">{{ __('Recipients') }}</th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach ($report->lines as $line)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-right tabular-nums text-gray-700">{{ $line->recipient_count }}</td>
                            ...
                            <tfoot class="bg-gray-100 border-t-2 border-gray-300">
                                <tr>
                                    <th scope="row" class="px-4 py-3 text-left font-semibold text-gray-900" colspan="2">{{ __('Overall totals') }}</th>
